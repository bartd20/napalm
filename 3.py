...
arista.open()
arista.load_merge_candidate(filename="arista1.lasthop.io-loopbacks")
print("Show config diff:")
print(arista.compare_config())
print("Discard config changes")
arista.discard_config()
print("Show config diff:")
print(arista.compare_config())
print("Load and apply the change")
arista.load_merge_candidate(filename="arista1.lasthop.io-loopbacks")
...
cisco.open()
cisco.load_merge_candidate(filename="cisco3.lasthop.io-loopbacks")
print("Show config diff:")
